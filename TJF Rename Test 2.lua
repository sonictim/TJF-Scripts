...
function GetInput(items)
      ...
      local retval, userinput = reaper.GetUserInputs("RENAME AND FORMAT ITEMS AND SOURCE", 5, "Description (FXName),Category (CatID),Designer,Project,Start Number (if any),extrawidth=400", name .. "," .. category .. "," .. designer .. "," .. project .. "," .. number)
...
function main()
      ...
      if reaper.GetSelectedMediaItem(0,0) then
          ...
          local newNames = GetInput(items) -- Ask user for input and build new names
