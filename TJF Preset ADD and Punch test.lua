...
function EnableAndArmAllParam(track, fx)
   ...
   for k = 0, reaper.TrackFX_GetNumParams( track, fx )-1 do  --Enable all Envelopes (Except Bypass) for chosen FX
       ...
       local BRenvelope = reaper.BR_EnvAlloc( envelope, false )
       ...
       reaper.BR_EnvSetProperties( BRenvelope, true, visible, true, inLane, laneHeight, defaultShape, faderScaling)
