--@description TJF Move Edit Cursor to End of Razor Edits
--@version 1.0
--@author Tim Farrell
--@links
...
--
--@about
--  # TJF Move Edit Cursor to End of Razor Edits
--
...
function Main()
    local test, position = GetRazorEditEnd()
