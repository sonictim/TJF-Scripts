--[[
   * ReaScript Name:TJF Glue Item and then open SampleEditor
   * Lua script for Cockos REAPER
   * Author: EUGEN27771 & TJF
   * Author URI: http://forum.cockos.com/member.php?u=50462
   * Licence: GPL v3
   * Version: 1.02.3
   * TJF added a quick command to glue the items to prevent damaging original source media
   * Description:TJF Glue Item and then open SampleEditor 
   * Changelog: just added this extra layer of functionality
...
reaper.Main_OnCommand(reaper.NamedCommandLookup("_S&M_COPYFXCHAIN2"), 0) --SWS/S&M: Copy FX chain from selected items
reaper.Main_OnCommand(41588, 0) --Item: Glue Items could ALSO use RENDER (41999,0) if you prefer
reaper.Main_OnCommand(reaper.NamedCommandLookup("_S&M_COPYFXCHAIN9"), 0) --SWS/S&M: Paste FX chain to selected items
