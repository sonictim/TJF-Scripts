...
function Main()
    ...
    then
          ...
          reaper.ApplyNudge(0, 0, 6, 2, .5, false, 0) -- Nudge edit cursor to the right by half grid unit
    ...
    then
          reaper.ApplyNudge(0, 0, 0, 2, .5, false, 0) -- Nudge items to the right by one grid unit
