...
function Main()
    ...
    then
          ...
          reaper.ApplyNudge(0, 2, 6, 2, 1, true, 0) -- Nudge edit cursor to the right by one grid unit
    ...
    then
          reaper.ApplyNudge(0, 2, 0, 2, 1, true, 0) -- Nudge items to the right by one grid unit
