--[[
@description TJF Fade In to Edit Cursor or Mouse (Hover Mode Dependant)
@version 2.1
@author Tim Farrell
@link http://github.com/sonictim/TJF-Scripts/
@date 2020 04 26
@about
  # TJF Fade In to Edit Cursor or Mouse (Hover Mode Dependant)
    Depending on Status of Hover mode will either fade in to edit cursor or mouse cursor
    Recommend Assigning to "D" key
@changelog
