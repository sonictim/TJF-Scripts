...
GUI.New("Subproject", "Checklist", {
    ...
    h = 125,
    caption = "",
    optarray = {"Render as Subproject", "Import Subproject", "End with New Project Selected", "Close New Project"},
    dir = "v",
    pad = 4,
    font_a = 2,
    font_b = 3,
...
GUI.New("Import", "Menubox", {
    ...
    h = 20,
    caption = "",
    optarray = {"To New Track", " Replace Selection"},
    retval = 1.0,
    font_a = 3,
    font_b = 4,
    col_txt = "txt",
