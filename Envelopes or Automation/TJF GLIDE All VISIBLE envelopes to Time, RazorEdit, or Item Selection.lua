--@description TJF GLIDE Envelope Points to all VISIBLE Envelopes to Time Selection or Selected Items
--@version 2.2
--@author Tim Farrell
--
--@about
--  # TJF GLIDE Envelope Points to all VISIBLE Envelopes to Time Selection or Selected Items
--  Mimic's Protools OPT + /  or more realistically X
    ...
    then
       ...
       for i=1, #AutoItems do
            ...
            if AutoItems[i] ~= -1 then
             ...
             reaper.DeleteEnvelopePointRangeEx( envelope, AutoItems[i], pointstart, pointend+Smoothing )
             reaper.InsertEnvelopePointEx( envelope, AutoItems[i], pointstart, startvalue, 0, 1, 0, true )
