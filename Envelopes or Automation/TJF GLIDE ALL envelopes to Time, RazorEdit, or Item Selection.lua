--@description TJF GLIDE Envelope Points to ALL Envelopes to Time Selection or Selected Items
--@version 2.2
--@author Tim Farrell
--
--@about
--  # TJF GLIDE Envelope Points to ALL Envelopes to Time Selection or Selected Items
